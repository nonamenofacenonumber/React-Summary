...
export default function TodoListItem({ todo , deleteTodo , toggleTodoStatus , editTodoTitle }:{todo:any,deleteTodo:Function,toggleTodoStatus:Function,editTodoTitle:Function}) {
                ...
                :  (
                    <div className="flex items-center">
                        ...
                        <button type="button" className="absolute right-0 flex items-center space-x-1">
                            ...
                            <DeleteIcon className="" onClick={() => deleteTodo(todo)}/>
                        </button>
                    </div>
                )
            }
